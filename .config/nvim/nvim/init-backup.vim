...
" CTRL+Q = keluar semua window/tab
nnoremap <C-q> :qa<CR>
"
" CTRL+W = simpan semua lalu keluar
nnoremap <C-w> :wqa<CR>
"
...
" === Coc.nvim & Prettier ===
" Format otomatis saat simpan file tertentu
autocmd BufWritePre *.js,*.jsx,*.ts,*.tsx,*.css,*.scss,*.html,*.json,*.java,*.py,*.go :CocCommand prettier.formatFile
" Shortcut manual untuk format
nmap <leader>p :CocCommand prettier.formatFile<CR>

" Aktifkan devicons dengan icon material
if exists('*webdevicons#setup')
call webdevicons#setup({
\ 'override': {},
\ 'color_icons': v:false,
\ 'default': v:true
\ })
